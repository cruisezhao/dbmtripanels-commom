...
class Ticket(models.Model):
    ...
    def email_followup(self):
        """return email followup"""
        email_followup = self.followup_set.filter(title__startswith="Email")
        return email_followup

    def other_followup(self):
        """return followup exclude email"""
        return self.followup_set.exclude(title__startswith = "Email")
